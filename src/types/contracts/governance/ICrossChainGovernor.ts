...
export interface ICrossChainGovernorInterface extends utils.Interface {
  functions: {
...
export interface ICrossChainGovernor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICrossChainGovernorInterface;
