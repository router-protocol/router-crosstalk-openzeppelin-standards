...
export interface ICrossChainERC20Interface extends utils.Interface {
  functions: {
...
export interface ICrossChainERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICrossChainERC20Interface;
