...
export interface ICrossChainERC1155MetadataURIInterface
...
export interface ICrossChainERC1155MetadataURI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICrossChainERC1155MetadataURIInterface;
