...
export interface CrossChainERC721PausableInterface extends utils.Interface {
  functions: {
...
export interface CrossChainERC721Pausable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrossChainERC721PausableInterface;
